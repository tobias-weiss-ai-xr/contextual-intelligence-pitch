...
Contextual Intelligence (CI) ist eine KI-SaaS-Plattform für B2B-Lead-Intelligence im MedTech-Bereich. Ein semantischer Wissensgraph auf selbst-gehosteten Foundation-Modellen identifiziert Technologie-Partner automatisch — statt starrer Keywords. Das Lead-Intelligence-MVP ist live.

\textbf{Problem:} MedTech-Vertrieb ist intransparent; bestehende Tools (Apollo, ZoomInfo, LinkedIn Sales Navigator) haben null Technologie-Kontext und sind keyword-basiert.
...
\textbf{Zielgruppe:} MedTech-B2B-Vertriebsteams, Medizintechnik-Hersteller (KMU bis Konzern), Zulieferer, Kliniken.

\textbf{Problem:} Bestehende B2B-Datenbanken (Apollo, ZoomInfo, LinkedIn Sales Navigator) sind generisch und keyword-basiert — sie verstehen keine spezialisierten Medizintechnologien und deren Überlappungen. Cold Outreach ohne Signal-Bezug hat niedrige Conversion. Regulatorische Signale (FDA, EUDAMED, ClinicalTrials) bleiben ungenutzt.

\textbf{USP:} CI kombiniert:
\begin{enumerate}[nosep,leftmargin=1.8em]
  \item \textbf{Lead Intelligence} (live) — fokussiert auf MedTech-Regulatorik und Zulassungen
  \item \textbf{Semantischer Wissensgraph} (Dgraph) — kontextuelles Verständnis statt Keywords
  \item \textbf{Sovereign-AI-Infrastruktur} — Souveräne Inferencing-Hardware, Open-Weight-Foundation-Modelle, vollständig DSGVO-/EU-AI-Act-konform, kein Datenabfluss in Drittstaaten
\end{enumerate}
...
\begin{description}[nosep,leftmargin=3em,style=nextline,itemsep=1.5pt]
  ...
  \item[Einnahmequellen] Lead Intelligence €299/Monat (B2B-Vertriebsteams); Lead Enterprise ab €1.000/Monat; ORSD Premium-API €99–€499/Monat.
  \item[Schlüsselressourcen] Souveräne Inferencing-Hardware (eingelegt), Dgraph-Wissensgraph, Postgres, React 19 + Express + Nuxt 3 (Open Source), ORSD-Dataset (6 Tabellen, 22 Crawler).
  \item[Schlüsselaktivitäten] Foundation-Model-Betrieb, Crawler-Wartung (FDA, EUDAMED, ClinicalTrials), Scoring-Tuning, Content-Marketing (MDR/IVDR), ORSD-Community-Aufbau.
  \item[Schlüsselpartner] Hetzner (Hosting), Uni Gießen, Datenquellen (FDA, EUDAMED, ClinicalTrials), StartMiUp/Hochschulnetzwerk (Pilotkunden).
\end{description}
...
\textbf{Innovation — drei USPs im DACH-MedTech-Markt:}
\begin{enumerate}[nosep,leftmargin=1.8em]
  \item \textbf{Sovereign AI} — Open-Weight-Modelle auf lokaler Hardware (kein US-Hyperscaler)
  \item \textbf{Graph-basiertes Lead-Scoring} speziell für MedTech-Regulatorik
  \item \textbf{Product-led Growth} ohne Sales-Team — das Produkt verkauft sich selbst
\end{enumerate}

\textbf{Umsetzbarkeit:} Lead-Intelligence-MVP live. Website produktiv, Inferencing-Hardware vorhanden. Y1: 10--20 Pilotkunden (€9k--€18k ARR). Self-funded (bootstrapping); ERP-Gründerkredit bei starkem Wachstum optional.
