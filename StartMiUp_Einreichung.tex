...
\textcolor{ci-light}{\textbf{Antragsteller:}} & Dr. Tobias Weiß \\
                                              & \textcolor{ci-light}{openDesk (GovDigital), Digitale Souveränität} \\
...
\begin{enumerate}[nosep,leftmargin=1.8em]
  ...
  \item \textbf{Sovereign-AI-Infrastruktur} — Open-Weight-Foundation-Modelle auf souveräner Hardware, vollständig DSGVO-/EU-AI-Act-konform, kein Datenabfluss in Drittstaaten
\end{enumerate}
...
\begin{description}[nosep,leftmargin=3em,style=nextline,itemsep=1.5pt]
  ...
  \item[Einnahmequellen] Lead Intelligence €299/Monat (B2B-Vertriebsteams); Lead Enterprise ab €1.000/Monat; Grant Intelligence €49–€149/Monat (geplant Q2 2027); ORSD Premium-API €99–€499/Monat. Zusätzlich: Forschungszulage (BZSt, 25\,\% F\&E-Personal), Förderprojekte (Uni Marburg MAFEX, StartMiUp, BMBF).
  \item[Schlüsselressourcen] Souveräne Open-Source Foundation Modelle (auf eigener Hardware), Dgraph-Wissensgraph, Postgres, React 19 + Express + Nuxt 3 (Open Source), ORSD-Dataset (6 Tabellen, 22 Crawler), ZenDis-API als Fallback.
  ...
  \item[Schlüsselpartner] Hetzner (Hosting), ZenDis (API), Uni Marburg (MAFEX), StartMiUp, Datenquellen (FDA, EUDAMED, Förderdatenbanken), StartMiUp/Hochschulnetzwerk (Pilotkunden).
\end{description}
...
\begin{enumerate}[nosep,leftmargin=1.8em]
  \item \textbf{Sovereign AI} — Souveräne Open-Source Foundation Modelle (kein US-Hyperscaler)
...
\textbf{Umsetzbarkeit:} Lead-Intelligence-MVP live (Siemens-Hackathon). Website produktiv, souveräne Open-Source FMs auf eigener Hardware. Y1: 10--20 Pilotkunden (€9k--€18k ARR). Funding: ERP-Gründerkredit €125k + Uni Marburg MAFEX €100k--500k + StartMiUp + BMBF.
