...
\begin{description}[nosep,leftmargin=3em,style=nextline,itemsep=1.5pt]
  ...
  \item[Schlüsselressourcen] Souveräne Open-Source Foundation Modelle (auf eigener Hardware), Dgraph-Wissensgraph, Postgres, React 19 + Express + Nuxt 3 (Open Source), ORSD-Dataset (6 Tabellen, 22 Crawler).
  ...
  \item[Schlüsselpartner] Hetzner (Hosting), Uni Marburg (MAFEX), StartMiUp, Datenquellen (FDA, EUDAMED, Förderdatenbanken), StartMiUp/Hochschulnetzwerk (Pilotkunden).
\end{description}
