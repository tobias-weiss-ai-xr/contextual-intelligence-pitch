...
\begin{description}[nosep,leftmargin=3em,style=nextline,itemsep=1.5pt]
  ...
  \item[Schlüsselressourcen] Souveräne Open-Source Foundation Modelle (auf eigener Hardware), Dgraph-Wissensgraph, Postgres, React 19 + Express + Nuxt 3 (Open Source), ORSD-Dataset (6 Tabellen, 22 Crawler), z.ai-API als Fallback.
...
\textbf{Umsetzbarkeit:} Lead-Intelligence-MVP live (Siemens-Hackathon). Website produktiv, souveräne Open-Source FMs auf eigener Hardware. Y1: 10--20 Pilotkunden (€9k--€18k ARR). Funding: ERP-Gründerkredit €125k + LOEWE €100k--500k + BMBF.
